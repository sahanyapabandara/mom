...
import MomUpload2 from "@/components/upload/MomUpload2.vue"
...
let component, dropzone, filelist, errorfiles
...
describe("MomUpload2", () => {
  beforeEach(() => {
    ...
    errorfiles = component.findComponent(MomUploadErrorFiles)
  })
  ...
  test("Default file upload", () => {
    ...
    expect(errorfiles.exists()).toBeFalsy()
  })
