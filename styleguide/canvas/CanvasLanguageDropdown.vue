<template>
  <div id="CanvasLanguageDropdown">
    <div class="rsg--preview-66">
      <MomLanguageDropdown :languages="languages" :currentLanguage="currentLanguage" />
    </div>
